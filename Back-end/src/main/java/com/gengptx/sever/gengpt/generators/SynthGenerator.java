...
import com.gengptx.sever.gengpt.structure.*;
...
public class SynthGenerator extends AbstractGenerator {
	/** Default values */
	static final int def_depth = 3,//3
						def_num_goal = 3,//3
						def_num_plan = 3,//3
						def_num_action = 3,//3
						def_num_var = 60,//60
						def_num_selected = 30;//30
	...
	public SynthGenerator(int seed, int tree_depth, int num_tree, int num_goal, int num_plan, int num_action, int num_var,
