 ...
 * @author: xueshanChen
 * @ClassName : Parameter
 * @description: the generator parameters of GenGPT-X
 * @version: v1.0
 */
...
//    number of groups
    private int sy_num_group;

    private int sy_num_var;
//    number of selected variables in each group
...
//    probability of a node becomes a leaf node
    ...
    public int getSy_num_group() {
        return sy_num_group;
    }

    public void setSy_num_group(int sy_num_group) {
        this.sy_num_group = sy_num_group;
    }
